package com.st.gateway.web.rest;

import com.st.gateway.config.Constants;
import com.st.gateway.domain.User;
import com.st.gateway.repository.UserRepository;
import com.st.gateway.security.AuthoritiesConstants;
import com.st.gateway.service.MailService;
import com.st.gateway.service.UserService;
import com.st.gateway.service.dto.AdminUserDTO;
import com.st.gateway.web.rest.errors.BadRequestAlertException;
import com.st.gateway.web.rest.errors.EmailAlreadyUsedException;
import com.st.gateway.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.st.gateway.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
