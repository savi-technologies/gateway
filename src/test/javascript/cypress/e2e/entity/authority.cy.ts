...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '57e29830-0c4a-4cdf-baa6-5660594ec7f4' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('9f67254f-6dc3-4d0c-9439-f55456d74b18');
      cy.get(`[data-cy="name"]`).should('have.value', '9f67254f-6dc3-4d0c-9439-f55456d74b18');
